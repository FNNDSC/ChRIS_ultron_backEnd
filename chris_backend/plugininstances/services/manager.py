...
class PluginAppManager(object):
    ...
    def run_plugin_app(plugin_inst, parameter_dict, **kwargs):
        ...
        Run a plugin's app.
        """
        str_service = kwargs['service'] if 'service' in kwargs else ''
        ...
        if 'inputDirOverride' in kwargs:
            str_inputDirOverride = kwargs['inputDirOverride']
        str_outputDirOverride = ''
        if 'outputDirOverride' in kwargs:
            str_outputDirOverride = kwargs['outputDirOverride']
        ...
        chris_service.app_manage(method=str_service, IOPhost=str_IOPhost)
