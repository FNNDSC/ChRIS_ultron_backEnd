...
urlpatterns = format_suffix_patterns([
    ...
    path(
        'v1/chrisinstance/<int:pk>/',
        core_views.ChrisInstanceDetail.as_view(),
        name='chrisinstance-detail',
    ),


    path(
        'v1/',
        feed_views.FeedList.as_view(),
        name='feed-list',
    ),

    path(
        'v1/search/',
        feed_views.FeedListQuerySearch.as_view(),
        name='feed-list-query-search',
    ),

    path(
        'v1/<int:pk>/',
        feed_views.FeedDetail.as_view(),
        name='feed-detail',
    ),

    path(
        'v1/note<int:pk>/',
        feed_views.NoteDetail.as_view(),
        name='note-detail',
    ),

    path(
        'v1/<int:pk>/grouppermissions/',
        feed_views.FeedGroupPermissionList.as_view(),
        name='feedgrouppermission-list',
    ),

    path(
        'v1/<int:pk>/grouppermissions/search/',
        feed_views.FeedGroupPermissionListQuerySearch.as_view(),
        name='feedgrouppermission-list-query-search',
    ),

    path(
        'v1/grouppermissions/<int:pk>/',
        feed_views.FeedGroupPermissionDetail.as_view(),
        name='feedgrouppermission-detail',
    ),

    path(
        'v1/<int:pk>/userpermissions/',
        feed_views.FeedUserPermissionList.as_view(),
        name='feeduserpermission-list',
    ),

    path(
        'v1/<int:pk>/userpermissions/search/',
        feed_views.FeedUserPermissionListQuerySearch.as_view(),
        name='feeduserpermission-list-query-search',
    ),

    path(
        'v1/userpermissions/<int:pk>/',
    ...
    path(
        'v1/<int:pk>/comments/',
        feed_views.CommentList.as_view(),
        name='comment-list',
    ),

    path(
        'v1/<int:pk>/comments/search/',
        feed_views.CommentListQuerySearch.as_view(),
        name='comment-list-query-search',
    ),

    path(
        'v1/comments/<int:pk>/',
        feed_views.CommentDetail.as_view(),
        name='comment-detail',
    ),

    path(
        'v1/<int:pk>/plugininstances/',
        feed_views.FeedPluginInstanceList.as_view(),
        name='feed-plugininstance-list',
    ),

    path(
        'v1/<int:pk>/tags/',
        feed_views.FeedTagList.as_view(),
        name='feed-tag-list',
    ),

    path(
        'v1/<int:pk>/taggings/',
        feed_views.FeedTaggingList.as_view(),
        name='feed-tagging-list',
    ),

    path(
        'v1/tags/',
        feed_views.TagList.as_view(),
        name='tag-list',
    ),

    path(
        'v1/tags/search/',
        feed_views.TagListQuerySearch.as_view(),
        name='tag-list-query-search',
    ),

    path(
        'v1/tags/<int:pk>/',
        feed_views.TagDetail.as_view(),
        name='tag-detail',
    ),

    path(
        'v1/tags/<int:pk>/feeds/',
        feed_views.TagFeedList.as_view(),
        name='tag-feed-list',
    ),

    path(
        'v1/tags/<int:pk>/taggings/',
        feed_views.TagTaggingList.as_view(),
        name='tag-tagging-list',
    ),

    path(
        'v1/taggings/<int:pk>/',
        feed_views.TaggingDetail.as_view(),
        name='tagging-detail',
    ),
    ...
    path(
        'v1/publicfeeds/',
        feed_views.PublicFeedList.as_view(),
        name='publicfeed-list',
    ),

    path(
        'v1/publicfeeds/search/',
    ...
    path(
        'v1/computeresources/',
        plugin_views.ComputeResourceList.as_view(),
        name='computeresource-list',
    ),

    path(
        'v1/computeresources/search/',
        plugin_views.ComputeResourceListQuerySearch.as_view(),
        name='computeresource-list-query-search',
    ),

    path(
        'v1/computeresources/<int:pk>/',
        plugin_views.ComputeResourceDetail.as_view(),
        name='computeresource-detail',
    ),
    ...
    path(
        'v1/plugins/',
        plugin_views.PluginList.as_view(),
        name='plugin-list',
    ),

    path(
        'v1/plugins/search/',
        plugin_views.PluginListQuerySearch.as_view(),
        name='plugin-list-query-search',
    ),

    path(
        'v1/plugins/<int:pk>/',
        plugin_views.PluginDetail.as_view(),
        name='plugin-detail',
    ),

    path(
        'v1/plugins/<int:pk>/parameters/',
        plugin_views.PluginParameterList.as_view(),
        name='pluginparameter-list',
    ),

    path(
        'v1/plugins/parameters/<int:pk>/',
        plugin_views.PluginParameterDetail.as_view(),
        name='pluginparameter-detail',
    ),

    path(
        'v1/plugins/<int:pk>/computeresources/',
    ...
    path(
        'v1/pacs/sse/',
        pacsfile_consumers.PACSFileProgressSSE.as_view(),
    ),
