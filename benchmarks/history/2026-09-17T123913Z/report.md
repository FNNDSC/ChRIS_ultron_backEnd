...
**Run:** 2026-09-17T123913Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 8.34 | 200.5 | 0 | 6 |  |

_Peak CPU at level 1: worker-periodic 20.7% (per service: {'worker-periodic': 20.7, 'worker-mains': 0.6, 'chris': 9.8, 'celery-scheduler': 3.4, 'db': 19.6, 'nats': 0.1, 'dragonflydb': 8.7, 'pfcon': 0.0})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 13.4 / 15.5 |
