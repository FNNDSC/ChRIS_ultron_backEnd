...
**Run:** 2026-09-17T055413Z  •  **Tier:** full  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 26.37 | 131.4 | 0 | 2 |  |
| 2 | PASS | 46.74 | 73.8 | 0 | 3 |  |
| 4 | PASS | 74.7 | 197.2 | 0 | 5 |  |
| 8 | PASS | 142.09 | 213.9 | 0 | 9 |  |
| 16 | PASS | 268.08 | 115.6 | 0 | 17 |  |

_Peak CPU at level 16: chris 76.2% (per service: {'chris': 76.2, 'celery-scheduler': 3.1, 'worker-periodic': 22.2, 'worker-mains': 25.3, 'nats': 0.1, 'dragonflydb': 17.5, 'pfcon': 3.4, 'db': 24.4})_

_Peak disk write at level 16: db 3.7 MiB (per service: {'worker-periodic': '192.0 KiB', 'worker-mains': '844.0 KiB', 'pfcon': '132.0 KiB', 'db': '3.7 MiB'})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 13.1 / 14.9 |
