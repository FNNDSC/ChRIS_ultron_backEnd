...
**Run:** 2026-06-16T172040Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** f4e27c6 (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 8.34 | 413.9 | 0 | 6 |  |

_Peak CPU at level 1: db 13.4% (per service: {'worker-periodic': 12.3, 'worker-mains': 6.8, 'chris': 5.1, 'celery-scheduler': 2.5, 'pfcon': 2.6, 'db': 13.4, 'nats': 0.1, 'dragonflydb': 5.3})_
...
| Engine | 27.3.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 5.3 / 6.3 |
