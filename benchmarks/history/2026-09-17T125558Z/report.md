...
**Run:** 2026-09-17T125558Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 8.41 | 385.1 | 0 | 6 |  |

_Peak CPU at level 1: db 14.1% (per service: {'worker-periodic': 9.0, 'worker-mains': 10.5, 'chris': 8.8, 'celery-scheduler': 2.0, 'db': 14.1, 'nats': 0.1, 'dragonflydb': 8.6, 'pfcon': 0.0})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 13.9 / 15.1 |
