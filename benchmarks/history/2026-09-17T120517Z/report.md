...
**Run:** 2026-09-17T120517Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 8.38 | 93.8 | 0 | 6 |  |

_Peak CPU at level 1: worker-mains 26.6% (per service: {'worker-periodic': 12.3, 'worker-mains': 26.6, 'chris': 4.9, 'celery-scheduler': 2.2, 'db': 13.9, 'nats': 0.1, 'dragonflydb': 8.1, 'pfcon': 0.0})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 13.0 / 15.1 |
