...
**Run:** 2026-06-16T235952Z  •  **Tier:** full  •  **Storage:** fslink  •  **Commit:** f4e27c6 (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 76.61 | 218.1 | 0 | 2 |  |
| 2 | PASS | 142.03 | 82.1 | 0 | 3 |  |
| 4 | PASS | 280.11 | 64.9 | 0 | 5 |  |
| 8 | PASS | 550.11 | 74.2 | 0 | 9 |  |

_Peak CPU at level 8: worker-mains 22.2% (per service: {'worker-mains': 22.2, 'celery-scheduler': 2.7, 'worker-periodic': 18.9, 'chris': 13.8, 'pfcon': 2.0, 'db': 17.0, 'dragonflydb': 7.2, 'nats': 0.1})_

_Peak disk write at level 8: db 5.4 MiB (per service: {'worker-mains': '916.0 KiB', 'worker-periodic': '364.0 KiB', 'pfcon': '56.0 KiB', 'db': '5.4 MiB'})_
...
| Engine | 27.3.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 11.3 / 13.8 |
