...
**Run:** 2026-06-16T172514Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** f4e27c6 (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 9.41 | 468.2 | 0 | 6 |  |

_Peak CPU at level 1: db 28.8% (per service: {'worker-periodic': 13.3, 'worker-mains': 9.7, 'chris': 3.9, 'celery-scheduler': 3.1, 'pfcon': 3.5, 'db': 28.8, 'nats': 0.0, 'dragonflydb': 9.5})_
...
| Engine | 27.3.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 10.0 / 12.8 |
