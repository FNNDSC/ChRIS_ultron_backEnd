...
**Run:** 2026-06-16T234231Z  •  **Tier:** full  •  **Storage:** fslink  •  **Commit:** f4e27c6 (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 68.28 | 195.0 | 0 | 2 |  |
| 2 | PASS | 131.44 | 212.5 | 0 | 3 |  |
| 4 | PASS | 259.65 | 149.7 | 0 | 5 |  |
| 8 | PASS | 516.94 | 88.5 | 0 | 9 |  |

_Peak CPU at level 8: worker-mains 24.1% (per service: {'worker-mains': 24.1, 'chris': 12.9, 'celery-scheduler': 3.1, 'worker-periodic': 16.1, 'pfcon': 1.4, 'db': 18.7, 'dragonflydb': 7.0, 'nats': 0.1})_

_Peak disk write at level 8: db 7.0 MiB (per service: {'worker-mains': '1.1 MiB', 'worker-periodic': '448.0 KiB', 'pfcon': '56.0 KiB', 'db': '7.0 MiB'})_
...
| Engine | 27.3.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 11.5 / 13.8 |
