...
**Run:** 2026-06-16T184631Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** f4e27c6 (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 9.36 | 489.8 | 0 | 6 |  |

_Peak CPU at level 1: worker-periodic 14.3% (per service: {'worker-periodic': 14.3, 'worker-mains': 8.9, 'chris': 9.7, 'celery-scheduler': 2.8, 'pfcon': 2.5, 'db': 9.7, 'nats': 0.1, 'dragonflydb': 5.4})_
...
| Engine | 27.3.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 9.3 / 12.3 |
