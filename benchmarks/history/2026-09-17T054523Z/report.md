...
**Run:** 2026-09-17T054523Z  •  **Tier:** full  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 8.42 | 176.2 | 0 | 2 |  |
| 2 | PASS | 12.75 | 89.1 | 0 | 3 |  |
| 4 | PASS | 20.53 | 209.4 | 0 | 5 |  |
| 8 | PASS | 35.56 | 87.3 | 0 | 9 |  |
| 16 | PASS | 66.68 | 101.9 | 0 | 17 |  |

_Peak CPU at level 16: worker-mains 25.4% (per service: {'worker-mains': 25.4, 'worker-periodic': 18.4, 'celery-scheduler': 3.2, 'chris': 17.7, 'nats': 0.1, 'dragonflydb': 8.3, 'pfcon': 3.4, 'db': 19.7})_

_Peak disk write at level 16: db 2.9 MiB (per service: {'worker-mains': '648.0 KiB', 'worker-periodic': '156.0 KiB', 'pfcon': '104.0 KiB', 'db': '2.9 MiB'})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 13.3 / 15.5 |
