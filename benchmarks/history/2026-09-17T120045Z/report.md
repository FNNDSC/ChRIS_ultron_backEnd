...
**Run:** 2026-09-17T120045Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 8.38 | 92.4 | 0 | 6 |  |

_Peak CPU at level 1: db 13.3% (per service: {'worker-periodic': 5.7, 'worker-mains': 0.1, 'chris': 5.8, 'celery-scheduler': 0.0, 'db': 13.3, 'nats': 0.1, 'dragonflydb': 7.8, 'pfcon': 0.0})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 13.0 / 14.3 |
