...
**Run:** 2026-06-16T190409Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** f4e27c6 (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 8.4 | 624.8 | 0 | 6 |  |

_Peak CPU at level 1: worker-mains 32.3% (per service: {'worker-periodic': 10.1, 'worker-mains': 32.3, 'chris': 5.2, 'celery-scheduler': 3.2, 'pfcon': 3.2, 'db': 7.5, 'nats': 0.1, 'dragonflydb': 7.5})_
...
| Engine | 27.3.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 9.5 / 16.3 |
