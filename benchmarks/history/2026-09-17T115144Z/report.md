...
**Run:** 2026-09-17T115144Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 8.37 | 218.4 | 0 | 6 |  |

_Peak CPU at level 1: db 15.7% (per service: {'worker-periodic': 9.0, 'worker-mains': 1.7, 'chris': 7.7, 'celery-scheduler': 0.0, 'db': 15.7, 'nats': 0.1, 'dragonflydb': 8.0, 'pfcon': 0.0})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 12.9 / 16.3 |
