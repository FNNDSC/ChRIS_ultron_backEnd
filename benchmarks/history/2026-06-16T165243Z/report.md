...
**Run:** 2026-06-16T165243Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** f4e27c6 (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 9.38 | 850.6 | 0 | 6 |  |

_Peak CPU at level 1: worker-periodic 18.3% (per service: {'worker-periodic': 18.3, 'worker-mains': 8.6, 'chris': 5.1, 'celery-scheduler': 2.8, 'pfcon': 3.6, 'db': 11.8, 'nats': 0.0, 'dragonflydb': 5.8})_
...
| Engine | 27.3.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 11.0 / 11.9 |
