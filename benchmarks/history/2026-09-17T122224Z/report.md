...
**Run:** 2026-09-17T122224Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 9.44 | 122.1 | 0 | 6 |  |

_Peak CPU at level 1: db 22.8% (per service: {'worker-periodic': 13.5, 'worker-mains': 11.2, 'chris': 5.5, 'celery-scheduler': 2.7, 'db': 22.8, 'nats': 0.1, 'dragonflydb': 8.4, 'pfcon': 0.0})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 12.8 / 13.9 |
