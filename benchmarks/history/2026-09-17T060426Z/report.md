...
**Run:** 2026-09-17T060426Z  •  **Tier:** full  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 67.67 | 130.1 | 0 | 2 |  |
| 2 | PASS | 132.83 | 202.3 | 0 | 3 |  |
| 4 | PASS | 259.85 | 74.9 | 0 | 5 |  |
| 8 | PASS | 515.55 | 99.2 | 0 | 9 |  |

_Peak CPU at level 8: chris 59.7% (per service: {'chris': 59.7, 'worker-mains': 21.9, 'worker-periodic': 23.3, 'celery-scheduler': 5.2, 'nats': 0.3, 'dragonflydb': 18.5, 'pfcon': 1.7, 'db': 23.8})_

_Peak disk write at level 8: db 5.3 MiB (per service: {'worker-mains': '668.0 KiB', 'worker-periodic': '144.0 KiB', 'pfcon': '56.0 KiB', 'db': '5.3 MiB'})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 13.4 / 14.6 |
