...
**Run:** 2026-06-16T182857Z  •  **Tier:** aging-probe  •  **Storage:** fslink  •  **Commit:** f4e27c6 (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 8.33 | 504.2 | 0 | 6 |  |

_Peak CPU at level 1: worker-periodic 12.7% (per service: {'worker-periodic': 12.7, 'worker-mains': 8.3, 'chris': 5.2, 'celery-scheduler': 2.2, 'pfcon': 3.4, 'db': 11.5, 'nats': 0.0, 'dragonflydb': 5.9})_
...
| Engine | 27.3.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 11.4 / 12.8 |
