...
**Run:** 2026-09-17T072342Z  •  **Tier:** full  •  **Storage:** fslink  •  **Commit:** 30fbbaf (dirty: true)
...
|---|---|---|---|---|---|---|
| 1 | PASS | 11.84 | 123.4 | 0 | 6 |  |
| 2 | PASS | 11.31 | 189.9 | 0 | 12 |  |
| 4 | PASS | 13.55 | 136.8 | 0 | 24 |  |
| 8 | PASS | 17.56 | 325.4 | 0 | 48 |  |
| 16 | PASS | 91.39 | 298.9 | 0 | 96 |  |

_Peak CPU at level 16: worker-mains 141.3% (per service: {'celery-scheduler': 3.0, 'worker-periodic': 18.3, 'worker-mains': 141.3, 'chris': 84.4, 'nats': 0.1, 'db': 79.9, 'dragonflydb': 8.5, 'pfcon': 12.7})_

_Peak disk write at level 16: db 30.4 MiB (per service: {'worker-periodic': '144.0 KiB', 'worker-mains': '3.2 MiB', 'db': '30.4 MiB', 'pfcon': '372.0 KiB'})_
...
| Engine | 29.8.0 |
| API auth | token |
| Noise floor (health p50/p95 ms) | 13.4 / 15.8 |
